    ...
    <div className="mt-8 flex flex-col gap-3 sm:flex-row">
      ...
      <Button
        ...
        className={`h-12 flex-1 ${
          productIsWishlisted ? "border-red-500 text-red-500 hover:bg-red-50 hover:text-red-600" : ""
        }`}
        aria-label={
          productIsWishlisted ? "Remove product from wishlist" : "Add product to wishlist"
        }
      >
        <Heart
          className={`mr-2 h-5 w-5 ${productIsWishlisted ? "fill-red-500 text-red-500" : ""}`}
        />
