...
export default function HeroBanner({ initialProducts = [] }: HeroBannerProps) {
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Featured deals today</p>
              </div>
        ...
        <div className="group relative aspect-[16/7] overflow-hidden rounded-2xl bg-neutral-900">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-6 sm:p-8 lg:p-10">
            <div className="max-w-lg">
              ...
              <h1 className="mt-3 text-2xl font-bold leading-tight text-white drop-shadow-lg sm:text-3xl lg:text-4xl line-clamp-2">
                {product.name}
              </h1>
            ...
            <div className="max-w-lg">
              <div className="flex flex-wrap gap-3">
                <Link
                  ...
                  className="inline-flex h-11 items-center gap-2 rounded-xl bg-white px-6 text-sm font-semibold text-primary transition hover:bg-white/90"
                >
                  View Details
                  <ArrowRight className="h-4 w-4" />
                </Link>
                <button
                  ...
                  className="inline-flex h-11 items-center gap-2 rounded-xl bg-white/20 px-5 text-sm font-semibold text-white backdrop-blur transition hover:bg-white/30"
                >
                ...
                <button
                  ...
                  className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-white/20 backdrop-blur transition hover:bg-white/30"
                >
                  <Heart
                    className={`h-4 w-4 ${
